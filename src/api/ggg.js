export const data = [
  ...
  },
  {
    ...
    hdurl:
      "https://apod.nasa.gov/apod/image/2312/C2020_V2_ZTF_CHILESCOPE_DEBartlett.jpg",
    media_type: "image",
    service_version: "v1",
  ...
  },
  {
    ...
    hdurl:
      "https://apod.nasa.gov/apod/image/2312/Heart_TelLiveOstling_2953.jpg",
    media_type: "image",
    service_version: "v1",
    title: "Deep Field: The Heart Nebula",
    url: "https://apod.nasa.gov/apod/image/2312/Heart_TelLiveOstling_960.jpg",
  },
  {
    copyright: "\nGiulio Cobianchi\n",
    date: "2024-01-29",
    ...
    hdurl:
      "https://apod.nasa.gov/apod/image/2312/ArcticNight_Cobianchi_2048.jpg",
    media_type: "image",
    service_version: "v1",
    title: "Aurora and Milky Way over Norway",
    url: "https://apod.nasa.gov/apod/image/2312/ArcticNight_Cobianchi_1080.jpg",
  },
  {
    date: "2024-01-30",
    explanation:
...
export const getData = async (date) => {
  const result = data.filter((obj) => obj.date === date);
  return result[0];
};
